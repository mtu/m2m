...
int RightBranket(const string& s, string & str_bf_rb)
{
...
int SynTreeSQ::ParseTree(const string&s, int mode)
{
...
using RelationTree::TreeNode;
	...
	else if(word[word.length()-1]==']')brkNum = RightBranket(word,str_bf_rb);
